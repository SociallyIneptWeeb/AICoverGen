        ...
        with gr.Tab("Generate"):
            ...
            with gr.Accordion('Voice conversion options', open=False):
                with gr.Row():
                    ...
                    with gr.Column():
                        f0_method = gr.Dropdown(['rmvpe', 'fcpe', 'rmvpe+', 'mangio-crepe'], value='rmvpe', label='Pitch detection algorithm', info='Best option is rmvpe (clarity in vocals), then mangio-crepe (smoother vocals)')
